...
class JobscloudSpider(scrapy.Spider):
    ...
    def start_requests(self):
        # pagination using feed_num
        for page in range(1, 20):  # twenty pages to scrape for now
            url = f"https://www.jobscloud.net/?view=recommendedjobs&format=nothtml&ajax=linefeed&feed_num={page}"
